    ...
    <div class="detailsBoxB">
        ...
        ?>
            ...
            if (isset($_POST['SubmitButton'])) {
                // changed this
                $id = intval(mysqli_query($con,"SELECT id From `Users` WHERE $tempID"));
                $name = $_POST['name'];
                ...
                // changed this
                $sql = "insert into `billingdetails` (id,name, billingEmail, nameOnCard, address,debitCardNumber, city, county, postcode, expyear, expmonth, cvv, product,productPrice,date) 
            values('$id','$name','$billingEmail','$nameOnCard','$address','$debitCardNumber','$city','$county ','$postcode','$expyear','$expmonth','$cvv','$product','$productprice',CURRENT_TIME())";
                        ...
                        <form method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-50">
                                    ...
                                    <input type="text" class="formInput" id="expmonth" name="expmonth" placeholder="09">
                                    <div class="row">
                                        <div class="col-50">
